...
class Employees_model extends CI_Model
{
	...
	// Custom Check EKTP
	public function check_employee_ektp($ektp)
	{

		$sql = 'SELECT * FROM xin_employees WHERE ektp = ?';
		$binds = array($ektp);
		$query = $this->db->query($sql, $binds);
		return $query->num_rows();
	}
	...
	// Custom Check NIK KK
	public function check_employee_nik_kk($nik_kk)
	{

		$sql = 'SELECT * FROM xin_employees WHERE nik_kk = ?';
		$binds = array($nik_kk);
		$query = $this->db->query($sql, $binds);
		return $query->num_rows();
	}
