          ...
          <div class="card-footer text-center py-3">
            <div class="row">
              <div class="col">
                ...
                <strong class="text-big"><?php echo $this->Xin_model->set_percentage($emp_abs); ?>%</strong>
              </div>
              <div class="col">
                <div class="text-muted small"><?php echo $this->lang->line('xin_emp_working'); ?></div>
                <strong class="text-big"><?php echo $this->Xin_model->set_percentage($emp_work); ?>%</strong>
              </div>
            </div>
          </div>
        </div>
