                              ...
                              <?php foreach ($transfer->result() as $r) { ?>
                                ...
                                <tr>
                                  ...
                                  <?php foreach ($location as $l) { ?>
                                    <td>Location : <?php echo $l->location_name; ?> </br>
                                    <?php } ?>

                                    <?php
                                    // Ambil nama department
                                    $department = $this->Department_model->get_department_name($department_id);
                                    if (!is_null($department)) {
                                      $department_name = $department[0]->department_name;
                                    } else {
                                      $department_name = "__";
                                    ...
                                    <?php foreach ($department as $d) { ?>
                                      <small class="text-muted"><i>Department : <?php echo $d->department_name; ?></i></small><br>
                                    <?php } ?>
